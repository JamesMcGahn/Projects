...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.list_items_button.setObjectName("list_items_button")

        self.verticalLayout.addWidget(self.list_items_button)

        self.set_item_button = QPushButton(Widget)
        self.set_item_button.setObjectName("set_item_button")
    ...
    def retranslateUi(self, Widget):
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("Widget", "1", None))
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Widget", "2", None))
        ___qtablewidgetitem2 = self.tableWidget.verticalHeaderItem(0)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Widget", "One", None))
        ___qtablewidgetitem3 = self.tableWidget.verticalHeaderItem(1)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Widget", "Two", None))

        __sortingEnabled = self.tableWidget.isSortingEnabled()
        self.tableWidget.setSortingEnabled(False)
        ___qtablewidgetitem4 = self.tableWidget.item(0, 0)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("Widget", "The ", None))
        ___qtablewidgetitem5 = self.tableWidget.item(0, 1)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("Widget", "sky", None))
        ___qtablewidgetitem6 = self.tableWidget.item(1, 0)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("Widget", "is", None))
        ___qtablewidgetitem7 = self.tableWidget.item(1, 1)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("Widget", "blue", None))
        self.tableWidget.setSortingEnabled(__sortingEnabled)

        self.list_items_button.setText(
            QCoreApplication.translate("Widget", "List Items", None)
        )
        self.set_item_button.setText(
            QCoreApplication.translate("Widget", "Set Item", None)
        )
